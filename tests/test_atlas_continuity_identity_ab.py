...
def _receipt(*, chain: str, identity: float, temporal: float = 0.94,
             motion: float = 0.92, artifact: float = 1.0):
    reports = []
...
def test_ab_gate_rejects_hidden_per_shot_identity_regression():
    ...
    candidate["quality_reports"][2]["measurement"]["metrics"]["identity_similarity"] = 0.70
    candidate["quality_reports"][0]["measurement"]["metrics"]["identity_similarity"] = 1.0
    candidate["quality_reports"][1]["measurement"]["metrics"]["identity_similarity"] = 1.0
...
def test_ab_gate_rejects_reused_render_chain():
    ...
    candidate["quality_reports"][0]["measurement"]["metrics"]["identity_similarity"] = 0.90
